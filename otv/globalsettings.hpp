...
#ifndef PULSEVIEW_OTV_GLOBALSETTINGS_HPP
#define PULSEVIEW_OTV_GLOBALSETTINGS_HPP
...
public:
	...
	static void store_timestamp(QSettings &settings, const char *name, const otv::util::Timestamp &ts);
	static otv::util::Timestamp restore_timestamp(QSettings &settings, const char *name);
...
#endif // PULSEVIEW_OTV_GLOBALSETTINGS_HPP
