...
TriggerMarker::TriggerMarker(View &view, const otv::util::Timestamp& time) :
	TimeItem(view),
	time_(time)
{
}
...
void TriggerMarker::set_time(const otv::util::Timestamp& time)
{
	time_ = time;
...
const otv::util::Timestamp TriggerMarker::time() const
{
	return time_;
}
...
{
	return (float)((time_ - view_.offset()) / view_.scale());
}
