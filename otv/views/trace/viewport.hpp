...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_VIEWPORT_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_VIEWPORT_HPP
...
private:
	std::optional<otv::util::Timestamp> drag_offset_;
	int drag_v_offset_;
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_VIEWPORT_HPP
