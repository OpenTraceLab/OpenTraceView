...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_LOGICSIGNAL_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_LOGICSIGNAL_HPP
...
public:
	...
	LogicSignal(otv::Session &session, shared_ptr<data::SignalBase> base);
...
protected:
	...
	shared_ptr<otv::data::LogicSegment> get_logic_segment_to_paint() const;

	void init_trigger_actions(QWidget *parent);

	const vector<int32_t> get_trigger_types() const;
	QAction* action_from_trigger_type(const opentrace::TriggerMatchType *type);
	const opentrace::TriggerMatchType* trigger_type_from_action(
		QAction *action);
...
protected:
	...
	const opentrace::TriggerMatchType *trigger_match_;
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_LOGICSIGNAL_HPP
