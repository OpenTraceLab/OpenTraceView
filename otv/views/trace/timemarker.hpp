...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_TIMEMARKER_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_TIMEMARKER_HPP
...
protected:
	 ...
	 */
	TimeMarker(View &view, const QColor &color, const otv::util::Timestamp& time);

public:
	/**
	 * Gets the time of the marker.
	 */
	virtual const otv::util::Timestamp time() const override;

	/**
	 * Sets the time of the marker.
	 */
	void set_time(const otv::util::Timestamp& time) override;
	...
	virtual otv::widgets::Popup* create_popup(QWidget *parent) override;

private Q_SLOTS:
	void on_popup_closed();

	void on_value_changed(const otv::util::Timestamp& value);

protected:
	const QColor &color_;

	otv::util::Timestamp time_;

	QSizeF text_size_;

	QWidgetAction *value_action_;
	otv::widgets::TimestampSpinBox *value_widget_;
};
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_TIMEMARKER_HPP
