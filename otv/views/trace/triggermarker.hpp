...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_TRIGGERMARKER_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_TRIGGERMARKER_HPP
...
public:
	 ...
	 */
	TriggerMarker(View &view, const otv::util::Timestamp& time);
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_TRIGGERMARKER_HPP
