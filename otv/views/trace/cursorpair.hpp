...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_CURSORPAIR_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_CURSORPAIR_HPP
...
public:
	...
	virtual const otv::util::Timestamp delta(const otv::util::Timestamp& other) const override;

	QPoint drag_point(const QRect &rect) const override;

	otv::widgets::Popup* create_popup(QWidget *parent) override;
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_CURSORPAIR_HPP
