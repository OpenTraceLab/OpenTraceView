...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_TIMEITEM_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_TIMEITEM_HPP
...
public:
	 ...
	 */
	virtual void set_time(const otv::util::Timestamp& time) = 0;

	/**
	 * Returns the time this time item is set to.
	 * @return 0 in case there is no valid time (e.g. for a cursor pair)
	 */
	virtual const otv::util::Timestamp time() const = 0;

	virtual float get_x() const = 0;

	virtual const otv::util::Timestamp delta(const otv::util::Timestamp& other) const;
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_TIMEITEM_HPP
