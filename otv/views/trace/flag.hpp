...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_FLAG_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_FLAG_HPP
...
public:
	 ...
	 */
	Flag(View &view, const otv::util::Timestamp& time, const QString &text);
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_FLAG_HPP
