...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_VIEWITEM_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_VIEWITEM_HPP
...
public:
	...
	virtual otv::widgets::Popup* create_popup(QWidget *parent);
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_VIEWITEM_HPP
