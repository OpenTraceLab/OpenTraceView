...
MathEditDialog::MathEditDialog(otv::Session &session,
	shared_ptr<otv::data::MathSignal> math_signal, QWidget *parent) :
	QDialog(parent),
	session_(session),
...
MathSignal::MathSignal(
	...
	math_signal_(dynamic_pointer_cast<otv::data::MathSignal>(base))
{
