...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_TRACEGROUP_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_TRACEGROUP_HPP
...
public:
	 ...
	 * Returns the session of the onwer.
	 */
	const otv::Session& session() const;
	...
	otv::widgets::Popup* create_popup(QWidget *parent);
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_TRACEGROUP_HPP
