...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_ANALOGSIGNAL_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_ANALOGSIGNAL_HPP
...
public:
	AnalogSignal(otv::Session &session, shared_ptr<data::SignalBase> base);
...
private:
	...
	shared_ptr<otv::data::AnalogSegment> get_analog_segment_to_paint() const;
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_ANALOGSIGNAL_HPP
