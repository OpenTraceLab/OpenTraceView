...
#ifndef PULSEVIEW_OTV_VIEWS_TRACE_SIGNAL_HPP
#define PULSEVIEW_OTV_VIEWS_TRACE_SIGNAL_HPP
...
protected:
	Signal(otv::Session &session, shared_ptr<data::SignalBase> signal);
...
#endif // PULSEVIEW_OTV_VIEWS_TRACE_SIGNAL_HPP
