...
#ifndef PULSEVIEW_OTV_DEVICES_HARDWAREDEVICE_HPP
#define PULSEVIEW_OTV_DEVICES_HARDWAREDEVICE_HPP
...
{
public:
	HardwareDevice(const shared_ptr<opentrace::Context> &context,
		shared_ptr<opentrace::HardwareDevice> device);

	~HardwareDevice();

	shared_ptr<opentrace::HardwareDevice> hardware_device() const;
...
#endif // PULSEVIEW_OTV_DEVICES_HARDWAREDEVICE_HPP
