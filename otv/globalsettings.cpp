...
void GlobalSettings::store_timestamp(QSettings &settings, const char *name, const otv::util::Timestamp &ts)
{
	stringstream ss;
...
otv::util::Timestamp GlobalSettings::restore_timestamp(QSettings &settings, const char *name)
{
