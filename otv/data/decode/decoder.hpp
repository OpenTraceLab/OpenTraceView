...
#ifndef PULSEVIEW_OTV_DATA_DECODE_DECODER_HPP
#define PULSEVIEW_OTV_DATA_DECODE_DECODER_HPP
...
public:
	Decoder(const otd_decoder *const dec, uint8_t stack_level);

	virtual ~Decoder();

	const otd_decoder* get_otd_decoder() const;
	...
	otd_decoder_inst* create_decoder_inst(otd_session *session);
...
private:
	const otd_decoder* const otd_decoder_;
	...
	otd_decoder_inst *decoder_inst_;
};
...
#endif // PULSEVIEW_OTV_DATA_DECODE_DECODER_HPP
