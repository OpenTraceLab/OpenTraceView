...
#ifndef PULSEVIEW_OTV_DATA_SEGMENT_HPP
#define PULSEVIEW_OTV_DATA_SEGMENT_HPP
...
protected:
	...
	otv::util::Timestamp start_time_;
	double samplerate_;
...
typedef std::shared_ptr<otv::data::Segment> SharedPtrToSegment;

Q_DECLARE_METATYPE(SharedPtrToSegment);

#endif // PULSEVIEW_OTV_DATA_SEGMENT_HPP
