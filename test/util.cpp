...
namespace {
	...
	otv::util::SIPrefix unspecified = otv::util::SIPrefix::unspecified;
	otv::util::SIPrefix yocto       = otv::util::SIPrefix::yocto;
	otv::util::SIPrefix nano        = otv::util::SIPrefix::nano;
/*	otv::util::SIPrefix micro       = otv::util::SIPrefix::micro; // Not currently used */
	otv::util::SIPrefix milli       = otv::util::SIPrefix::milli;
	otv::util::SIPrefix none        = otv::util::SIPrefix::none;
	otv::util::SIPrefix kilo        = otv::util::SIPrefix::kilo;
	otv::util::SIPrefix yotta       = otv::util::SIPrefix::yotta;

/*	otv::util::TimeUnit Time = otv::util::TimeUnit::Time; // Not currently used */
}  // namespace
